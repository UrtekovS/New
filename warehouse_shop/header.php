...
<head>
    ...
    <title>"Экзамен "Склад-магазин""</title>
...
<header>
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark " id="testes">
    ...
    <img class="my_logo" src="imge/logo.png">
      <a class="navbar-brand" id="admin" href="#" >Экзамен "Склад-магазин"</a>
      <div class="collapse navbar-collapse justify-content-end" id="navbarCollapse">
        <form class="d-flex"  onsubmit="return false;">
        <input class="form-control me-2" type="search" placeholder="Поиск по катологу" aria-label="Search" id="poisk">
            <button class="btn btn-outline-primary" type="button" onclick="poisck();" id="Search">Поиск<!DOCTYPE html>
            <html lang="en">
        </form>
      </div>
    </div>
    <div class="collapse navbar-collapse " id="navbarCollapse">
        ...
        <div>
            ...
            <a class="navbar-brand" href="user_korzina.php" >карзина</a>
