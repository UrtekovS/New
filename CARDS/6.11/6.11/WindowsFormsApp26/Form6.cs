...
namespace WindowsFormsApp26
{
    public partial class Form6 : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "restoranDataSet13.Categories". При необходимости она может быть перемещена или удалена.
            this.categoriesTableAdapter3.Fill(this.restoranDataSet17.Categories);
