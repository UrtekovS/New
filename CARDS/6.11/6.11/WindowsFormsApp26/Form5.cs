...
namespace WindowsFormsApp26
{
    public partial class Form5 : Form
    {
        ...
        public void load()
        {
            //this.dishTableAdapter.Fill(this.restoranDataSet14.Dish);
            this.dishTableAdapter2.Fill(this.restoranDataSet15.Dish);
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "restoranDataSet17.Dish". При необходимости она может быть перемещена или удалена.
            this.dishTableAdapter3.Fill(this.restoranDataSet17.Dish);
            // TODO: данная строка кода позволяет загрузить данные в таблицу "restoranDataSet15.Dish". При необходимости она может быть перемещена или удалена.
            //this.dishTableAdapter2.Fill(this.restoranDataSet15.Dish);//
            // TODO: данная строка кода позволяет загрузить данные в таблицу "restoranDataSet14.Dish". При необходимости она может быть перемещена или удалена.
            //this.dishTableAdapter.Fill(this.restoranDataSet14.Dish);
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
           ...
           // f.categoriesTableAdapter2.Fill(f.restoranDataSet9.Categories);
            f.categoriesTableAdapter3.Fill(f.restoranDataSet17.Categories);
            ...
            if (f.ShowDialog() == DialogResult.OK)
            {
                ...
                string s = "insert into Dish(Name,Price, Calories,Sostav," +
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            if (dataGridView1.CurrentRow != null)
            {
                ...
                f.categoriesTableAdapter3.Fill
                (f.restoranDataSet17.Categories);//!!!!!
