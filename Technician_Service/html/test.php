    ...
    <main>
        ...
        <section>
            <div class="gap black-layer opc8 overlap144">
                ...
                <div class="container">
                    <div class="pg-tp-wrp">
                        <h1 itemprop="headline">Our Firefighters</h1>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html" title="" itemprop="url">Home</a></li>
                            <li class="breadcrumb-item active">Our Firefighters</li>
                        </ol>
                    </div><!-- Page Top Wrap -->
                </div>
            </div>
                ...
                <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6 col-lg-4">
                                <div class="tm-bx">
                                    ...
                                    <div class="tm-inf">
                                        <h5 itemprop="headline"><a href="team-detail.html" title="" itemprop="url">John Alex</a></h5>
                            ...
                            <div class="col-md-4 col-sm-6 col-lg-4">
                                <div class="tm-bx">
                                    ...
                                    <div class="tm-inf">
                                        <h5 itemprop="headline"><a href="team-detail.html" title="" itemprop="url">Timz Hal</a></h5>
                            ...
                            <div class="col-md-4 col-sm-6 col-lg-4">
                                <div class="tm-bx">
                                    <div class="tm-thmb">
                                        <a href="team-detail.html" title="" itemprop="url"><img src="assets/images/resources/tm-img4.jpg" alt="tm-img4.jpg" itemprop="image"></a>
                                        <div class="scl2">
                                            <a class="theme-bg" href="#" title="Twitter" itemprop="url" target="_blank"><i class="fab fa-twitter"></i></a>
                                            <a class="theme-bg" href="#" title="Facebook" itemprop="url" target="_blank"><i class="fab fa-facebook-f"></i></a>
                                            <a class="theme-bg" href="#" title="Linkedin" itemprop="url" target="_blank"><i class="fab fa-linkedin-in"></i></a>
                                    ...
                                    <div class="tm-inf">
                                        <h5 itemprop="headline"><a href="team-detail.html" title="" itemprop="url">Nelly Ed</a></h5>
                                        <span class="theme-clr">Fire Fighter</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6 col-lg-4">
                                <div class="tm-bx">
                                    <div class="tm-thmb">
                                        <a href="team-detail.html" title="" itemprop="url"><img src="assets/images/resources/tm-img5.jpg" alt="tm-img5.jpg" itemprop="image"></a>
                                        <div class="scl2">
                                            <a class="theme-bg" href="#" title="Twitter" itemprop="url" target="_blank"><i class="fab fa-twitter"></i></a>
                                            <a class="theme-bg" href="#" title="Facebook" itemprop="url" target="_blank"><i class="fab fa-facebook-f"></i></a>
                                            <a class="theme-bg" href="#" title="Linkedin" itemprop="url" target="_blank"><i class="fab fa-linkedin-in"></i></a>
                                    ...
                                    <div class="tm-inf">
                                        <h5 itemprop="headline"><a href="team-detail.html" title="" itemprop="url">Alex Bond</a></h5>
                                        <span class="theme-clr">Fire Fighter</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6 col-lg-4">
                                <div class="tm-bx">
                                    <div class="tm-thmb">
                                        <a href="team-detail.html" title="" itemprop="url"><img src="assets/images/resources/tm-img6.jpg" alt="tm-img6.jpg" itemprop="image"></a>
                                        <div class="scl2">
                                            <a class="theme-bg" href="#" title="Twitter" itemprop="url" target="_blank"><i class="fab fa-twitter"></i></a>
                                            <a class="theme-bg" href="#" title="Facebook" itemprop="url" target="_blank"><i class="fab fa-facebook-f"></i></a>
                                            <a class="theme-bg" href="#" title="Linkedin" itemprop="url" target="_blank"><i class="fab fa-linkedin-in"></i></a>
                                    ...
                                    <div class="tm-inf">
                                        <h5 itemprop="headline"><a href="team-detail.html" title="" itemprop="url">Suzie De</a></h5>
                                        <span class="theme-clr">First Aid Officer</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="pgn-wrp text-center">
                        <ul class="pagination">
                            ...
                            <li class="pg-lst">....</li>
							<li class="page-item"><a class="page-link" href="#" itemprop="url">4</a></li>
